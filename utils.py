...
def pretreatment_line(line, contents, tokenizer, pad_size):
...
def build_dataset(config):
    ...
    dev = load_ds(config.dev_path, config.pad_size)
    test = load_ds(config.test_path, config.pad_size)
